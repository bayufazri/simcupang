...
<head>
	...
	<link rel="stylesheet" href="{{ asset('frontend/vendor/chartist/css/chartist-custom.css') }}">
	<!-- MAIN CSS -->
...
<body>
	...
	<script src="{{ asset('frontend/vendor/jquery-slimscroll/jquery.slimscroll.min.js') }}"></script>
	...
	<script src="{{ asset('frontend/scripts/klorofil-common.js') }}"></script>
	<script>
	$(function() {
		var data, options;
